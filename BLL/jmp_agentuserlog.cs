...
namespace JMP.BLL
{
    ...
    public partial class jmp_agentuserlog
    {
        ...
        private readonly JMP.DAL.jmp_agentuserlog dal = new JMP.DAL.jmp_agentuserlog();
        public jmp_agentuserlog()
        { }
        ...
        /// 获得数据列表
        /// </summary>
        public List<JMP.MDL.jmp_agentuserlog> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<JMP.MDL.jmp_agentuserlog> DataTableToList(DataTable dt)
        {
            List<JMP.MDL.jmp_agentuserlog> modelList = new List<JMP.MDL.jmp_agentuserlog>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                JMP.MDL.jmp_agentuserlog model;
                for (int n = 0; n < rowsCount; n++)
                {
                    model = new JMP.MDL.jmp_agentuserlog();
