...
function AddTab(name, isLeaf, href, id, type) {
    ...
    if (isLeaf !== undefined) {
        ...
        var ifrhei = hei - 144;//iframe可见高度

        if (type == "child") {
            hei = document.documentElement.clientHeight + 144;
        ...
        tab.append('<li class="active"><span data-href="' + href + '" onclick="tabmenu(this,\'' + id + '\')">' + name + '</span> <i class="fa fa-times-circle" onclick="tabClose(this)"></i></li>');//$("#tab-panel-menu-list").
        tabper.append('<div class="cont active"><iframe name="' + id + '" src="' + href + '" height=' + ifrhei + ' ></iframe></div>');
