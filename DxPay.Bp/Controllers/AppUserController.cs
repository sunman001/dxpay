...
namespace DxPay.Bp.Controllers
{
    ...
    {  private static readonly ILogWriter Logger = LogWriterManager.GetOperateLogger;
        ...
        public ActionResult AppUserList()
        {
            ...
            string query = "select * from jmp_user a  left join  CoServiceFeeRatioGrade  b  on a.ServiceFeeRatioGradeId=b.Id   where relation_type=" + (int)Relationtype.Bp + " and relation_person_id='"+userid+"' " + where;
