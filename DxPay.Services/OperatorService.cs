...
{
    public class OperatorService : GenericService<jmp_operator>, IOperatorService
    {
        ...
        public jmp_operator FindBytime(string start, string end)
        {
        ...
        public IEnumerable<jmp_operator> FindPagedList(int userid,  string orderBy, string stime, string etime, string a_name)
        {
            var where = new List<string>();
        ...
        public IEnumerable<jmp_operator> FindPagedListByBp(int userid, string orderBy, string stime, string etime, string a_name)
        {
            var where = new List<string>();
            string bpWhere = "";
            string agentWhere = "";
