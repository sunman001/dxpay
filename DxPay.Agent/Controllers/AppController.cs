...
namespace DxPay.Bp.Controllers
{
    public class AppController : Controller
    {
        ...
        public ActionResult AppList()
        {
            ...
            var list = _AppService.FindPagedListBySql(userid, (int)Relationtype.Agent, "", platformid, auditstate, sea_name, type, SelectState, searchDesc, null, pageIndexs, PageSize);
