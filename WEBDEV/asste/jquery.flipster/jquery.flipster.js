    ...
    return this.each(function(){
        ...
        function jump(to) {
            if ( _flipItems.length > 1 ) {
                ...
                $(".paybank-botc p").removeClass("on");
                $(".paybank-botc .c"+_current).addClass("on");
                center();
            }
        }
        ...
        function init() {
            // Basic setup
            _flipster.addClass("flipster flipster-active flipster-" + settings.style).css("overflow-y", "hidden");/*visibility*/
            ...
            _flipster.hide().css("overflow-y", "hidden").fadeIn(400, function () { center(); });
