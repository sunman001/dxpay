...
if(isIE){
    ...
    if(safariVersion <= DEFAULT_VERSION ){
        location.href = "loading.html";//location.href实现客户端页面的跳转  
    }
}
...
//  }
    /*else {
        $(".nav-smart li").removeClass("active");
        $(".nav-smart").eq(4).find("li").eq(0).addClass("active");
        $(".nav-smart").eq(4).parent().addClass("active");
    }*/
