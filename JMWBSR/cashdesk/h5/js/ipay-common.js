...
var ipay = {};
ipay['cfg'] = {};
ipay['cfg']['icon_loading'] = 'https://web.iapppay.com/pub/img/loading.gif';
		...
		ajax4lock : function(setting) {
			...
			var maskOpts = {
				...
				message : '<span style="width:33px; height:33px; background:url(' + ipay['cfg']['icon_loading']
						+ ') no-repeat; background-size:100%; position:relative;  display:block;margin: 20px auto 10px auto;">&nbsp;</span><span style="text-align: center; color:#eee; font-size:14px;">' + msg + '</span>',
				overlayCSS : {
