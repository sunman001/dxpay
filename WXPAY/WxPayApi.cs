...
namespace WxPayAPI
{
    public class WxPayApi
    {
        ...
        */
        public static WxPayData Micropay(WxPayData inputObj, int tid, int timeOut = 10)
        {
            ...
            inputObj.SetValue("spbill_create_ip", wx.IP);//终端ip
        ...
        */
        public static WxPayData OrderQuery(WxPayData inputObj,int tid, int timeOut = 6)
        {
        ...
        */
        public static WxPayData Reverse(WxPayData inputObj,int tid, int timeOut = 6)
        {
        ...
        */
        public static WxPayData Refund(WxPayData inputObj,int tid, int timeOut = 6)
        {
	    ...
	    * @return 成功时返回，其他抛异常
	    */
	    public static WxPayData ShortUrl(WxPayData inputObj,int tid, int timeOut = 6)
	    {
        ...
        * @return 成功时返回，其他抛异常
        */
        public static WxPayData UnifiedOrder(WxPayData inputObj,int tid, int timeOut = 6)
        {
            ...
            //签名
            inputObj.SetValue("sign", inputObj.MakeSign(tid));
            string xml = inputObj.ToXml();
	    ...
	    * @return 成功时返回，其他抛异常
	    */
	    public static WxPayData CloseOrder(WxPayData inputObj,int tid, int timeOut = 6)
	    {
	    ...
	    */
        private static void ReportCostTime(string interface_url, int timeCost, WxPayData inputObj,int tid)
	    {
		    //如果不需要进行上报
	    ...
	    */
	    public static WxPayData Report(WxPayData inputObj,int tid, int timeOut = 1)
	    {
            ...
            inputObj.SetValue("appid", wx.APPID);//公众账号ID
		    inputObj.SetValue("mch_id", wx.MCHID);//商户号
		    inputObj.SetValue("user_ip", wx.IP);//终端ip
        ...
        * 根据当前系统时间加随机序列来生成订单号
         * @return 订单号
        */
        public static string GenerateOutTradeNo(int tid)
        {
            var ran = new Random();
            WxPayConfig wx = new WxPayConfig(tid);
            return string.Format("{0}{1}{2}", wx.MCHID, DateTime.Now.ToString("yyyyMMddHHmmss"), ran.Next(999));
        }
