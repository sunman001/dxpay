...
namespace JMNOTICE.Util.ListBoxExt
{
    ...
    public sealed class ListBoxLog : IDisposable
    {
        ...
        private void DrawItemHandler(object sender, DrawItemEventArgs e)
        {
            if (e.Index >= 0)
            {
                ...
                var logEvent = ((ListBox)sender).Items[e.Index] as LogEvent ??new LogEvent(Level.Critical, ((ListBox)sender).Items[e.Index].ToString());
        ...
        private void CopyToClipboard()
        {
            ...
            Clipboard.SetData(DataFormats.Text, selectedItemsAsRtfText.ToString());
        }
        ...
        public ListBoxLog(ListBox listBox, string messageFormat, int maxLinesInListbox)
        {
            ...
            MenuItem[] menuItems = { new MenuItem("复制选中日志", CopyMenuOnClickHandler) };
