...
namespace JmPayParameter.PayType
{
    ...
    /// 微信appid读取通道入口
    /// </summary>
    public class PayWxApp : PayTypeAbstract
    {
        /// <summary>
        /// 根据参数,读取通道信息
        /// </summary>
        ...
        public override PayChannelAbstract LoadChannel(int paymode, int arid, int CacheTime,int appid)
        {
            ...
            //payc.PassName = SelectPayChannel.SelectPassAppid(appid, paymode, CacheTime);
            payc.PassName = SelectPayChannel.SelectPass(5, paymode, arid, CacheTime, appid);
            return payc;
        }
