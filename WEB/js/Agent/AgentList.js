...
function SaveAgent() {
    ...
    if (stype == "0") {
        ...
        if (!exp2.test(rname)) {
            ...
            $("#DisplayName_tip").attr("class", "Validform_checktip Validform_wrong");
            $("#DisplayName_tip").html("公司名称由8-30位汉字组成！");
            return false;
    ...
    var BankAccountName = fd.BankAccountName;//
    var imgurl = "";//证件照片
    var imgurlSfz = "";
...
function SaveUpdateAgent() {
    ...
    if (sType == "0") {
        if (!exp1.test(name)) {
            ...
            $("#BankAccountName_tip").html("开户名称由1-6位汉字组成！");
            return false;
        ...
        if (!exp2.test(name)) {
            ...
            $("#BankAccountName_tip").attr("class", "Validform_checktip Validform_wrong");
            $("#BankAccountName_tip").html("开户名称由8-30位汉字组成！");
            return false;
...
function CheckName() {
    ...
    if (sType == "0") {
        ...
        if (!exp2.test(name)) {
            ...
            $("#BankAccountName_tip").attr("class", "Validform_checktip Validform_wrong");
            $("#BankAccountName_tip").html("开户名称由2-30位汉字组成！");
            return false;
