...
$(function () {
    ...
    $("#btnSaveAddComplaint").click(function () {
       ...
       // var c_result = $.trim($("#c_result").val());
...
//添加应用投诉管理
function AddAPPlog() {
    window.parent.ShouwDiaLogWan("添加应用投诉", 630, 630, "/REPORT/ComplaintAdd");
}
//选择支付渠道
...
function UpdateComplaint(c_id) {
    ...
    window.parent.ShouwDiaLogWan("修改应用投诉信息", 630, 630, "/REPORT/ComplaintAdd?c_id=" + c_id);
}
...
function bulkassign() {
    ...
    window.parent.ShouwDiaLogWan("处理应用投诉", 620, 260, "/REPORT/ComplaintCL?rid=" + vals);
}
//单个审核
function complaintLC(rid) {
    ...
    window.parent.ShouwDiaLogWan("处理应用投诉", 620, 260, "/REPORT/ComplaintCL?rid=" + rid);
}
