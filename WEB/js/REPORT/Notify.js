...
//添加通知短信分组信息
function AddAPPlog() {
    window.parent.ShouwDiaLogWan("添加通知短信分组信息", 800, 700, "/REPORT/NotificaitonEdit");
}
...
function UpdateComplaint(c_id) {
    ...
    window.parent.ShouwDiaLogWan("修改通知短信分组信息", 800, 700, "/REPORT/NotificaitonEdit?c_id=" + c_id);
}
