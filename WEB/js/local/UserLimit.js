...
function AddLimitDialog() {
    window.parent.ShouwDiaLogWan("添加权限", 600, 500, "/LIMIT/InsertUserLimit");
}
...
function UpdateLimitDialog(objId) {
    window.parent.ShouwDiaLogWan("更新权限", 600, 500, "/LIMIT/UserUpdateLimit?lid=" + objId);
};
...
function AddRoleDialog() {
    window.parent.ShouwDiaLogWan("添加角色", 600, 250, "/ROTE/AddUserRote");

}

function UpdateRoleDialog(objId) {
    window.parent.ShouwDiaLogWan("编辑角色", 600, 250, "/ROTE/RoleUserUpdate?rid=" + objId);
}

//设置权限弹出框
function UpdateRoleLimitDialog(objId) {
    window.parent.ShouwDiaLogWan("编辑角色权限", 800, 500, "/ROTE/UpdateRoleLimit?type=1&rid=" + objId);
}
