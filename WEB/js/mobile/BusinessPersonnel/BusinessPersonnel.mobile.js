...
$(document).ready(function () {
    ...
    $("#btnBusinessPersonnel").click(function () {
        ...
        var data = { LoginName: $.trim(loname), Password: $.trim(pwd), DisplayName: $.trim(name), EmailAddress: $.trim(email), MobilePhone: $.trim(phone), qq: $.trim(qq), Website: $.trim(Website), Id: $.trim(Id) };
...
function Updatestate(obj) {
    ...
    $.post("/BusinessPersonnel/CoAll", { coid: vals, tag: obj }, function (retJson) {
        if (retJson.success == 1) {
