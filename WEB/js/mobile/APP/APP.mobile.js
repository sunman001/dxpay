...
function ArticleManage(pageIndex, pageSize) {
    ...
    url += "&type=" + searchType + "&sea_name=" + sea_name + "&SelectState=" + SelectState + "&searchDesc=" + searchDesc + "&auditstate=" + auditstate + "&platformid=" + platformid + "&r_id=" + r_id;
...
function AddAppSp(a_id) {
    window.parent.ShouwDiaLogWan("添加商品", 800, 350, "/APP/AddGOODS?a_id=" + a_id);
}
//一键启用或禁用
...
//设置扣量
function getkl(obj) {
    window.parent.ShouwDiaLogWan("通道费率设置", 500, 350, "/App/AppKl?appid=" + obj);
}