...
function ArticleManage(pageIndex, pageSize) {
    ...
    url += "&searchType=" + $.trim(searchType) + "&searchname=" + $.trim(searchname) + "&stime=" + $.trim(stime) + "&etime=" + $.trim(etime) + "&paymode=" + $.trim(paymode) + "&paymentstate=" + $.trim(paymentstate) + "&noticestate=" + $.trim(noticestate) + "&platformid=" + platformid + "&relationtype=" + $.trim(relationtype);
