...
$(function () {
    ...
    $("#btnSaveAdd").click(function () {
        ...
        var data = {
            Id: $.trim(Id), Name: $.trim(Name), Code: $.trim(Code), Description: Description, NotifyMobileList: NotifyMobileList, NotifyMobileList: NotifyMobileList, MessageTemplate: MessageTemplate, IntervalUnit: IntervalUnit, IntervalValue: IntervalValue, IsAllowSendMessage: IsAllowSendMessage
        };
...
//添加通知短信分组信息
function AddAPPlog() {
    window.parent.ShouwDiaLogWan("添加通知短信分组信息", 950, 800, "/REPORT/NotificaitonEdit");
}
