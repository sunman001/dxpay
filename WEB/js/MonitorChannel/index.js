...
function CreateMonitorChannel() {
    window.parent.ShouwDiaLogWan("添加通道监控", 680, 560, "/monitorchannel/create");
}
//选择支付渠道
...
function UpdateComplaint(c_id) {
    //window.location.href = "/monitorchannel/edit?c_id=" + c_id;
    window.parent.ShouwDiaLogWan("修改通道监控", 650, 500, "/monitorchannel/edit?c_id=" + c_id);
}
