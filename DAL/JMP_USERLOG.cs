...
namespace JMP.DAL
{
    ...
    public partial class jmp_userlog
    {
        ...
        public bool Exists(int l_id)
        {
            ...
            strSql.Append("select count(1) from jmp_userlog");
            strSql.Append(" where ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into jmp_userlog(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update jmp_userlog set ");
        ...
        public bool Delete(int l_id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from jmp_userlog ");
            strSql.Append(" where l_id=@l_id");
            SqlParameter[] parameters = {
					new SqlParameter("@l_id", SqlDbType.Int,4)
			};
        ...
        public JMP.MDL.jmp_userlog GetModel(int l_id)
        {
            ...
            strSql.Append("  from jmp_userlog ");
            strSql.Append(" where l_id=@l_id");
            SqlParameter[] parameters = {
					new SqlParameter("@l_id", SqlDbType.Int,4)
			};
            ...
            JMP.MDL.jmp_userlog model = new JMP.MDL.jmp_userlog();
