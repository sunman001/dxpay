...
namespace JMP.DAL
{
    ...
    public partial class jmp_businessuserlog
    {
        ...
        public bool Exists(int l_id)
        {
            ...
            strSql.Append("select count(1) from jmp_businessuserlog");
            strSql.Append(" where ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into jmp_businessuserlog(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update jmp_businessuserlog set ");
        ...
        public bool Delete(int l_id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from jmp_businessuserlog ");
            strSql.Append(" where l_id=@l_id");
            SqlParameter[] parameters = {
					new SqlParameter("@l_id", SqlDbType.Int,4)
			};
        ...
        public JMP.MDL.jmp_businessuserlog GetModel(int l_id)
        {
            ...
            strSql.Append("  from jmp_businessuserlog ");
            strSql.Append(" where l_id=@l_id");
            SqlParameter[] parameters = {
					new SqlParameter("@l_id", SqlDbType.Int,4)
			};
            ...
            JMP.MDL.jmp_businessuserlog model = new JMP.MDL.jmp_businessuserlog();
        ...
        public List<JMP.MDL.jmp_businessuserlog> SelectList(string sqls, string Order, int pageIndexs, int PageSize, out int pageCount)
        {
            ...
            pageCount = Convert.ToInt32(da.SelectCommand.Parameters["@TotalCount"].Value);
            da.Dispose();
            return DbHelperSQL.ToList<JMP.MDL.jmp_businessuserlog>(ds.Tables[0]);
        }
